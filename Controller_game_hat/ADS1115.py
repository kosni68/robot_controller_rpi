...
class ADS1115:
	...
	def analog_read(self,channel):
		if channel == 0:
			...
			print("ERREUR Ads_7828 position")

		self.bus.write_i2c_block_data(self.i2c_address, ADS1115_REG_POINTER_CONFIG, CONFIG_REG)
		time.sleep(0.05)
	
        # Read data back from address, 2 bytes
        # raw_adc MSB, raw_adc LSBn
		data = self.bus.read_i2c_block_data(self.i2c_address, ADS1115_REG_POINTER_CONVERT, 2)
		time.sleep(0.05)
        #print(data)
		...
		voltage = raw_adc * 3290 / 26400/1000;

		# Output data to screen
		#print("Digital value of analog input :" ,raw_adc ," voltage :" ,round(voltage,2))
